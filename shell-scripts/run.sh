...
if [ "$USER" != "traffic" ]; then
  echo "This script must run as traffic user, not as $USER."
  exit 1
fi
...
APPLICATION_DIRECTORY=/home/traffic/sgTraffic/app
APPLICATION_START=server.js
PIDFILE=/home/traffic/sgTraffic/app.pid
LOGFILE=/home/traffic/sgTraffic/output.log
